	...
	render() {
		return (
			<div className="My_Skills">
				<h1 id="skills_title" onClick={() => this.expandText()}>
					Skills
				</h1>
				<div className="skills_container">
					<div className={this.state.expanded === true ? 'show_skills' : 'skills'}>
						<img
							id="node"
						...
						<img
							...
							alt="aws"
						/>
						<img id="d3" src="https://avatars3.githubusercontent.com/u/1562726?s=400&v=4" alt="d3" />
						<img
							id="firebase"
						...
						<img
							...
							alt="css"
						/>
						<img id="html5" src="https://seravo.fi/wp-content/uploads/2013/12/HTML5logo.png" alt="html5" />
					</div>
				</div>
			</div>
		);
